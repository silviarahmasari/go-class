    ...
    <div class="section-header">
        <div class="container-fluid">
            <ul class="nav justify-content-center">
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('teacher.classes.show', $kelas) }}">
                        <h5>Streaming</h5>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('teacher.task.index', $kelas) }}">
                        <h5>Tugas Kelas</h5>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('teacher.orang', $kelas) }}">
                        <h5>Orang</h5>
                    </a>
                </li>
            </ul>
            ...
            <div class="card rounded-lg col-12 p-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row pl-4 p-1">
                        <div class="col col-auto">
                            <img alt="image" src="{{ asset('assets/stisla/img/avatar/avatar-2.png') }}" class="rounded-circle" style="width: 25px; height:25px">
                        </div>
                        <div class="col col-10">
                            <h5>{{ $siswa->name }}</h5>
                        </div>
